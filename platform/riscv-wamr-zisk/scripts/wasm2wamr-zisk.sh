...
wamrc \
    ...
    --size-level=1 \
    --bounds-checks=0 \
    -o $OUTPUT.zisk.wamr $1

gcc platform/riscv-wamr-zisk/file2c/file2c.c \
    -o platform/riscv-wamr-zisk/file2c/file2c
...
platform/riscv-wamr-zisk/file2c/file2c \
    $OUTPUT.zisk.wamr \
    wasmModuleBuffer > $OUTPUT.zisk.wamr.c
...
# Source files
SOURCES=(
    platform/riscv-wamr-zisk/main.c
    platform/riscv-wamr-zisk/syscalls.c
    "$OUTPUT.zisk.wamr.c"
)

# Assembly source
ASM_SOURCE=platform/riscv-wamr-zisk/startup.S

# Linker script
LINKER_SCRIPT=platform/riscv-wamr-zisk/zkvm.ld
