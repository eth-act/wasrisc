...
OPT_LEVEL="-O1" ./platform/riscv-qemu-user/scripts/c2riscv-qemu-user.sh build/c-packages/stateless/ build/bin/stateless.riscv.O1.elf
...
./docker/docker-shell.sh qemu-riscv64 -plugin /libinsn.so build/bin/stateless.riscv.O1.elf >> go_benchmark_results.txt 2>&1
