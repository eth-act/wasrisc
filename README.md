...
|---|---|---|---|---|---|---|---|---|
| `reva-client-eth` (Rust) | 4,543,397,058 | 1,337,696,305 | 1,074,488,397 | doesn't work | ? | 2,472,559,016 | 1,944,993,041 | 388,564,723 |
| `stateless` (Go) | 6,039,298,186 | 2,154,036,727 | 874,758,419 | 953,874,491 | ? | 3,526,934,350 | 2,293,123,670 | 236,265,327 |
